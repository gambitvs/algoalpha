      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        {playing ? (
          ...
          <button
            ...
            className="group relative block aspect-video w-full max-w-4xl mx-auto rounded-lg overflow-hidden cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber/50"
          >
            <img
