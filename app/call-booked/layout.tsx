...
export const metadata: Metadata = {
  ...
  description:
    "Your consultation with the Algo Alpha team is booked. Check your email for the calendar invite and next steps.",
  robots: { index: false, follow: false },
  icons: { icon: "/favicon.png" },
  openGraph: {
    type: "website",
    siteName: "Algo Alpha",
    title: "Consultation Booked | Algo Alpha",
    description:
      "Your consultation with the Algo Alpha team is booked.",
    images: [
      {
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      {/* Meta Pixel #1 — PageView + Schedule conversion */}
